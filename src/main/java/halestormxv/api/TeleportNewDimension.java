...
public class TeleportNewDimension
{
    ...
    private TeleportNewDimension() {}

    public static void teleportMe(EntityPlayer player, int dimension, double x, double y, double z)
    {
