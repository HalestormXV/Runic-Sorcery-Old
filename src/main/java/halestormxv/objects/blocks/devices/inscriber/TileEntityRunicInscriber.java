...
public class TileEntityRunicInscriber extends TileEntity implements IInventory, ITickable
{
    ...
    {
        return this.hasCustomName() ? this.customName : "container.runic_inscriber";
    }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = RunicInscriberRecipes.getInstance().getInscriberResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem()
    {
        if(this.canSmelt())
        {
            ...
            ItemStack result = RunicInscriberRecipes.getInstance().getInscriberResult(input1, input2);
            ItemStack output = (ItemStack)this.inventory.get(3);
