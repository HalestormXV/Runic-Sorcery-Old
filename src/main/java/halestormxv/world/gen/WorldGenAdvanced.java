...
import halestormxv.world.gen.generators.AdvancedStructureGen;
...
public class WorldGenAdvanced extends WorldGenerator implements IWorldGenerator {


    static Random rand2 = new HighQualityRandom();
    @Override
    ...
    private void generateOverworld(World world, Random rand, int chance, int blockX, int blockZ)
    {
        if ((int) (Math.random() * chance) == 0)
        	{
        int y = getGroundFromAbove(world, blockX, blockZ);
        BlockPos pos = new BlockPos(blockX, y, blockZ);
        WorldGenerator structure = new AdvancedStructureGen("cultist_hut");
